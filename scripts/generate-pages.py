...
PAGES: list[dict] = [
    ...
    dict(path="gacha", frag="gacha.html", title="ふるさと納税 自治体ガチャ|全国1,741自治体からランダム抽選",
         desc="全国1,741自治体から、ふるさと納税の寄附先をランダムに1つ抽選。全国・地方・都道府県の範囲を選ぶだけで、無料で何度でも回せます。結果からそのまま返礼品もチェック。",
...
ARTICLES = [
    ("furusato-random", "ふるさと納税をランダムで選ぶ|全国1,741自治体からガチャで決定",
     "寄附先が多すぎて決められないなら、ランダムという選び方。全国1,741自治体を対象に、全国・地方・都道府県から範囲を指定してガチャで1つ抽選できます。無料・ログイン不要で何度でも。"),
    ...
    ("cant-decide", "ふるさと納税が決められない・選べないときの3つの決め方",
     "どこにするか決められないのは選択肢が多すぎるから。範囲だけ決めてランダムに任せる/予算から逆算する/テーマで選ぶ——比較疲れせずに今日決めるための実践ガイド。"),
    ("budget-first", "予算から考えるふるさと納税|上限を余らせないコツ",
     "先に予算(=上限の目安)を決めてから返礼品を組む逆転の発想。予算内おまかせガチャの活用法も。12月に慌てないための計画の立て方。"),
]
